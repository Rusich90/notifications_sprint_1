...
LOGGING_CONFIG = {
    ...
    "loggers": {
        "app_producer": {"handlers": ["console_handler"], "level": logging_conf.level, "propagate": False},
        "app_consumer": {"handlers": ["console_handler"], "level": logging_conf.level, "propagate": False},
